                    	...
                    	<div class="row clearfix">
                            <div class="col-lg-7 col-sm-6 col-xs-12 column">
                                <div class="footer-widget logo-widget">
                                    <div class="logo"><a href="index.html">Shri Visakha Industries</a></div>
                                 <!--   <div class="text">SVI is founded during 1975 by Mr.C.V.Thirugnanam & Mr.V.T.Vijayaraaghavan.</div> -->
                                    
                                    <ul class="contact-info">
										<strong>Unit - I</strong>
                                    	<li><span class="icon flaticon-pin"></span> 324, Puliyakulam Road , Coimbatore  – 641 045</li>
										<strong>Unit - II</strong>
										<li><span class="icon flaticon-pin"></span> 17/2,17/3 &17/5, Om Sakthi Industrial Estate, Sedarapet  – 605 111</li>
                                        <li><span class="icon flaticon-technology"></span>+ 91-98438 07744  / + 91-98438 07733</li>
                                        <li><span class="icon flaticon-mail-2"></span> visakaindustries@gmail.com</li>
                                    </ul>
